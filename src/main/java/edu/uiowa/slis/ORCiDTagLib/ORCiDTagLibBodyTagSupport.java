package edu.uiowa.slis.ORCiDTagLib;
...
public class ORCiDTagLibBodyTagSupport extends BodyTagSupport {

    protected DataSource theDataSource = null;
    protected Connection theConnection = null;

    public ORCiDTagLibBodyTagSupport() {
        super();
    }

    private static final Log log =LogFactory.getLog(ORCiDTagLibBodyTagSupport.class);
    ...
    public DataSource getDataSource() {
        if (theDataSource == null) try {
            theDataSource = (DataSource)new InitialContext().lookup("java:/comp/env/jdbc/ORCiDTagLib");
        } catch (Exception e) {
